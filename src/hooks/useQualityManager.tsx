    ...
    try {
      ...
      if (existingStats) {
        setReviewerStats({
          ...
          shortDecisionCount: existingStats.short_decision_count,
          shortDecisionStreaks: existingStats.short_decision_streaks,
          agreementRate: existingStats.agreement_rate,
    ...
    try {
      ...
      await supabase
        ...
        .update({
          ...
          short_decision_count: updatedStats.shortDecisionCount,
          short_decision_streaks: updatedStats.shortDecisionStreaks,
          agreement_rate: updatedStats.agreementRate,
